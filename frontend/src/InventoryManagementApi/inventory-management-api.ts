...
export class InventoryManagementApi {
  ...
  deleteOrder(order: Order): Observable<any> {
    ...
    return this.http.delete<void>('http://localhost:3020/api/orders/deleteOrder', {
      headers,
      body: order
    });
  }
  ...
  updateOrderItem(orderItem: OrderItem): Observable<OrderItem> {
    ...
    return this.http.put<OrderItem>(
      'http://localhost:3020/api/orders/updateOrderItem',
      orderItem,
      { headers }
    );
  }
  ...
  deleteOrderItem(orderItem: OrderItem): Observable<void> {
    ...
    return this.http.delete<void>(
      'http://localhost:3020/api/orders/deleteOrderItem',
      {
        headers,
        body: orderItem
      }
  ...
  updateStockQuantities(order: Order): Observable<Order> {
    ...
    return this.http.put<Order>(
      'http://localhost:3020/api/orders/updateStatusAndType',
      order,
      { headers }
    );
